// Type definitions for WebGL 2
// Project: https://www.khronos.org/registry/webgl/specs/latest/2.0
// Definitions by: Dan Glastonbury <dan.glastonbury@gmail.com>
// Definitions: https://github.com/djg/webgl2-ts
...
interface WebGL2RenderingContext extends WebGLRenderingContext {
    ...
    texSubImage3D(target: number, level: number, xoffset: number, yoffset: number, zoffset: number, format: number, type: number, pixels: ImageData): void;
    texSubImage3D(target: number, level: number, xoffset: number, yoffset: number, zoffset: number, format: number, type: number, image: HTMLImageElement): void;
    texSubImage3D(target: number, level: number, xoffset: number, yoffset: number, zoffset: number, format: number, type: number, canvas: HTMLCanvasElement): void;
    texSubImage3D(target: number, level: number, xoffset: number, yoffset: number, zoffset: number, format: number, type: number, video: HTMLVideoElement): void;
    ...
    uniform1uiv(location: WebGLUniformLocation, value: number[]): void;
    uniform1uiv(location: WebGLUniformLocation, value: Uint32Array): void;
    uniform2uiv(location: WebGLUniformLocation, value: number[]): void;
    uniform2uiv(location: WebGLUniformLocation, value: Uint32Array): void;
    uniform3uiv(location: WebGLUniformLocation, value: number[]): void;
    uniform3uiv(location: WebGLUniformLocation, value: Uint32Array): void;
    uniform4uiv(location: WebGLUniformLocation, value: number[]): void;
    uniform4uiv(location: WebGLUniformLocation, value: Uint32Array): void;

    uniformMatrix2x3fv(location: WebGLUniformLocation, transpose: boolean, value: number[]): void;
    uniformMatrix2x3fv(location: WebGLUniformLocation, transpose: boolean, value: Float32Array): void;
    uniformMatrix3x2fv(location: WebGLUniformLocation, transpose: boolean, value: number[]): void;
    uniformMatrix3x2fv(location: WebGLUniformLocation, transpose: boolean, value: Float32Array): void;
    uniformMatrix2x4fv(location: WebGLUniformLocation, transpose: boolean, value: number[]): void;
    uniformMatrix2x4fv(location: WebGLUniformLocation, transpose: boolean, value: Float32Array): void;
    uniformMatrix4x2fv(location: WebGLUniformLocation, transpose: boolean, value: number[]): void;
    uniformMatrix4x2fv(location: WebGLUniformLocation, transpose: boolean, value: Float32Array): void;
    uniformMatrix3x4fv(location: WebGLUniformLocation, transpose: boolean, value: number[]): void;
    uniformMatrix3x4fv(location: WebGLUniformLocation, transpose: boolean, value: Float32Array): void;
    uniformMatrix4x3fv(location: WebGLUniformLocation, transpose: boolean, value: number[]): void;
    uniformMatrix4x3fv(location: WebGLUniformLocation, transpose: boolean, value: Float32Array): void;
    vertexAttribI4i(index: number, x: number, y: number, z: number, w: number): void;
    vertexAttribI4iv(index: number, v: number[]): void;
    vertexAttribI4ui(index: number, x: number, y: number, z: number, w: number): void;
    vertexAttribI4uiv(index: number, v: number[]): void;
    ...
    clearBufferiv(buffer: number, drawbuffer: number, value: Int32Array): void;
    clearBufferuiv(buffer: number, drawbuffer: number, value: number[]): void;
    clearBufferuiv(buffer: number, drawbuffer: number, value: Uint32Array): void;
    clearBufferfv(buffer: number, drawbuffer: number, value: number[]): void;
    clearBufferfv(buffer: number, drawbuffer: number, value: Float32Array): void;
    ...
    getActiveUniforms(program: WebGLProgram, uniformIndices: number[], pname: number): number[];
